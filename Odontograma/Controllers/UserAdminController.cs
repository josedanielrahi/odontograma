...
namespace IdentitySample.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public ActionResult Solicitudes()
        {
            ...
            var roleUsers = RoleManager.Roles.Single(a => a.Name.Equals("Solicitud")).Users;
            var roleList = roleUsers.ToList();
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //var roleUsers = (RoleManager.Roles.Single(a => a.Name.Equals("Aspirante")).Users);

            //var list = (from r in users
            //            where r.RoleId == ""
